...
late final FlutterBluePlusPersistDeviceWidgetUtilsProvider<FlutterBluePlusDeviceWidgetUtil> bluetoothScannerController;
...
void main() async {
  ...
  bluetoothScannerController = FlutterBluePlusPersistDeviceWidgetUtilsProvider(
...
class AppRoot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MultiProvider(
        providers: [
          Provider<FlutterBluePlusPersistDeviceWidgetUtilsProvider<FlutterBluePlusDeviceWidgetUtil>>(create: (_) => bluetoothScannerController),
