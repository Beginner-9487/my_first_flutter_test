...
import 'package:utl_mobile/utl_bluetooth/utl_bt_handler_impl.dart';
...
late final BT_Provider bt_provider;
late ContextResource rootContextResource;

late final Electrochemical_Aggregate_Impl electrochemical_aggregate_impl;
late final Electrochemical_Aggregate_Handler electrochemical_aggregate_handler;
...
late final BT_Event_Handler? bt_event_handler;
...
void main() async {
  ...
  utl_bt_handler = UTL_BT_Handler_Impl.init(
    ...
    input_UUID: [BT_INPUT_UUID],
    output_UUID: [BT_OUTPUT_UUID],
  );
...
class AppRoot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final BT_Controller bt_controller = BT_Controller_Impl(bt_event_handler: bt_event_handler!);
    ...
    final Electrochemical_Line_Chart_Controller electrochemical_line_chart_controller = Electrochemical_Line_Chart_Controller_Impl(
      contextResource: rootContextResource,
      electrochemical_data_listener: electrochemical_data_listener,
    );
    return MaterialApp(
